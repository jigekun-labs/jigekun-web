      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="animate-fade-in-up">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <div
              aria-disabled="true"
              className="relative inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold text-[var(--gray-400)] bg-[var(--gray-100)] rounded-2xl cursor-not-allowed select-none"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
              </svg>
              {t("appStore")}
              <span className="absolute -top-2 -right-2 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white bg-[var(--gray-500)] rounded-full">
                {t("comingSoon")}
              </span>
            </div>
            <a
              href="https://play.google.com/store/apps/details?id=kr.co.jigekun.labs"
              target="_blank"
        ...
        <div className="relative bg-gradient-to-br from-[var(--primary)] to-[var(--primary-dark)] rounded-3xl p-12 md:p-20 overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
              <div
                aria-disabled="true"
                className="relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-white/30 text-white/60 font-semibold rounded-2xl cursor-not-allowed select-none"
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
                </svg>
                {t("ios")}
                <span className="absolute -top-2 -right-2 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[var(--primary)] bg-white rounded-full">
                  {t("comingSoon")}
                </span>
              </div>
              <a
